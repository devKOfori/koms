# Generated by Django 5.1.2 on 2024-12-28 23:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('room_status', models.CharField(choices=[('default', 'Default'), ('cleaned', 'Cleaned'), ('used', 'Used'), ('broken', 'Broken')], default='default', max_length=255)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.profile')),
                ('floor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.hotelfloor')),
                ('room_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rooms', to='api.roomtype')),
            ],
            options={
                'db_table': 'room',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_type', models.CharField(choices=[('member', 'Member'), ('non-member', 'Non-Member')], max_length=255)),
                ...
                ('sponsor_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.sponsortype')),
            ],
            options={
                'db_table': 'booking',
            },
